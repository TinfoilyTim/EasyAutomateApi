...
Easy Automate Api aims to simplify task execution and creation sush as bash scipts and python code. It runs all over Fast Api for easy javasript intergration.
